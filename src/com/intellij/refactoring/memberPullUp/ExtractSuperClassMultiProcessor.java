...
public class ExtractSuperClassMultiProcessor extends ExtractSuperBaseProcessor {

  public ExtractSuperClassMultiProcessor(Project project,
  ...
  protected PsiClass extractSuper(final String superClassName) throws IncorrectOperationException {
    return ExtractSuperClassMultiUtil.extractSuperClassMulti(myProject, myClass.getContainingFile().getContainingDirectory(), superClassName, myClass, myMemberInfos, myJavaDocPolicy, false);
  }
